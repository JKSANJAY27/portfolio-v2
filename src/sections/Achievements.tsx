...
const achievementItems = [
  { link: '#research', text: 'SET2026 Int. Conference Speaker — Kuala Lumpur, Malaysia 🇲🇾', image: '/set2026.png' },
  { link: '#projects', text: 'NextUp VIT — 100+ Active Users Placement Tracker', image: '/projects/nextup.png' },
  { link: '#', text: 'GATE CSE 2026 — AIR 1603 · Score 670', image: '/gate.png' },
  { link: '#research', text: 'UKIERI 2025 Research Scholar — Heriot-Watt University, Scotland', image: '/ukieri.jpeg' },
  { link: '#', text: 'Gen AI Using IBM Watsonx Certification', image: '/projects/ibm.png' },
...
const achievementCards = [
  {
    icon: '🌏',
    index: '01',
    title: 'SET2026 Int. Conference Speaker',
    description: 'Presented research on Physics-Augmented ML Digital Twins for Thermosyphon Heat Pipes at the 22nd International Conference on Sustainable Energy Technologies (SET2026) by WSSET in Kuala Lumpur, Malaysia. Journey: UKIERI-SPARC @ Heriot-Watt → SET2026 with Dr. Sakthivadivel D.',
    tags: ['SET2026', 'Kuala Lumpur 🇲🇾', 'WSSET', 'Speaker'],
    accent: '#D02020',
  },
  {
    icon: '🎓',
    index: '02',
    title: 'GATE CSE 2026 (AIR 1603)',
  ...
  },
  {
    icon: '🚀',
    index: '03',
    title: 'NextUp Placement Tracker (100+ Users)',
    description: 'Built & launched NextUp, an automated placement intelligence platform for VIT students. Features zero-knowledge client-side encryption, Gmail AI ingestion, and shortlist matching. Deployed live with 100+ active student users.',
    tags: ['100+ Active Users', 'Zero-Knowledge', 'Live App'],
    accent: '#F0C020',
  },
  {
    icon: '🏛️',
  ...
  },
  {
    ...
    description: 'Professional certification demonstrating expertise in Generative AI architectures, prompt engineering, model tuning, and enterprise LLM deployment using IBM Watsonx platform.',
    tags: ['IBM Certified', 'Generative AI', 'Watsonx'],
    accent: '#D02020',
  },
  {
    icon: '☁️',
